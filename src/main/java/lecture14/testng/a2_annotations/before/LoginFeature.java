...
public class LoginFeature {
	...
	public void provideBrowserCleanState(){
		...
		System.out.println();
		System.out.println("*****");
		System.out.println("BEFORE BEFORE METHOD METHOD METHOD");
	...
	@AfterMethod
	public void getSceenShotsFromExec(){
		System.out.println();
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
		System.out.println("AFTER EVERYT METHOD A SCEEN SHOT FOR THE PAGE IS TAKEN");
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
		System.out.println();
	}
